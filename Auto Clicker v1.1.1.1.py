...
def mainWindow():
        ...
        #intial stuff
        title= Label(mainWin, text= 'Auto Clicker v1.1.1')
        ...
        changelog=Label(mainWin, text= 'Changelog: v1.1.1 Improved UI and window now returns when auto clicker is stopped')
...
while clickTimes<clickAmount+1: 
    ...
    if isRunning==1:
        ...
        pyautogui.click(currentMouseX,currentMouseY,button=mouseButton)
        if outputPos=='true':
