...
def mainWindow():
        ...
        #intial stuff
        title= Label(mainWin, text= 'Auto Clicker v1.1.2')
        ...
        v1.1.2 clickFrequency now only affects click function instead of entire code preventing code from slowing code down if there is a slow click frequency""", wraplength=520)
