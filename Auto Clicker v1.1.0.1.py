...
#intial stuff
title= Label(mainWin, text= 'Auto Clicker v1.1.0.1')
...
changelog=Label(mainWin, text= 'Changelog: v1.1 Added basic UI')
...
def changeOutputPos():
    ...
    OPos.mainloop()
oposValue=StringVar()
oposValue.set('Current: Default (true)')
...
clickFreqValue.set('Current: Default (100)')
