...
def mainWindow():
        ...
        #intial stuff
        frame=CTkFrame(master=mainWin,bg_color="gray")
        frame.pack(fill='both',padx=70,pady=40)
        title= CTkLabel(frame, text= 'Auto Clicker v1.2.3',text_font=('roboto',30))
        credit= CTkLabel(frame, text='By Jaden909')
        mainWin.geometry("600x700")
        startButton = CTkButton(frame, text = 'Start Auto Clicker', command = start)
        updateValues=CTkButton(frame, text='Update Values', command=updateValue)
        changelog=CTkLabel(frame, text= """Patch Notes:
        ...
        NOTE=CTkLabel(frame, text="NOTE: Press ESC to bring this window back up after it is closed", wraplength=520)
        exitButton=CTkButton(frame, text='Exit',command=exitScript)
        ...
        global outputPos
        oposValue.set('Current: '+ outputPos)
        changeOPosButton = CTkButton(frame, text = 'Change mouse position output', command = changeOutputPos,text_font=('roboto',12))
        ...
        clickFreqValue.set('Current: ' + clickFrequency +'ms')
        changeClickFreqButton = CTkButton(frame, text = 'Change Click Frequency', command = changeClickFreq,text_font=('roboto',12))
        ...
        mouseButtonValue.set('Current: ' + mouseButton)
        changeMouseButtonButton = CTkButton(frame, text = 'Change Mouse Button', command = changeMouseButton,text_font=('roboto',12))
        ...
        clickTimesValue.set('Current: ' + clickAmount+' times')
        changeClickTimesButton = CTkButton(frame, text = 'Change Click Times', command = changeClickTimes,text_font=('roboto',12))
        ...
        infiniteValue.set('Current: ' + infiniteBool)
        changeinfiniteButton = CTkButton(frame, text = 'Infinite Mode', command = changeinfinite,text_font=('roboto',12))
        ...
        startKeyValue.set('Current: ' + startKey)
        changestartKeyButton = CTkButton(frame, text = 'Change Start Key', command = changestartKey,text_font=('roboto',12))
        ...
        stopKeyValue.set('Current: ' + stopKey)
        changestopKeyButton = CTkButton(frame, text = 'Change Stop Key', command = changestopKey,text_font=('roboto',12))
